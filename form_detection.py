...
def crop_image(pt1, pt2, image, numLabels, image_crop):
    ...
    if pt1[0] -10 < 0 : pt1 = (0, pt1[1])
    else: pt1 = (pt1[0] - 10, pt1[1])

    if pt1[1] - 10 < 0: pt1 = (pt1[0], 0)
    else: pt1 = (pt1[0], pt1[1] - 10)

    if pt2[0] + 10 > image.shape[1]: pt2 = (image.shape[1], pt2[1])
    else: pt2 = (pt2[0] + 10, pt2[1])

    if pt2[1] + 10 > image.shape[0]: pt2 = (pt2[0], image.shape[0])
    else: pt2 = (pt2[0], pt2[1] + 10)
